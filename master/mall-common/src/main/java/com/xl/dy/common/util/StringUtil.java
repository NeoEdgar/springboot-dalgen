...
//    }
    ...
    /**
     * 当判断Obj是为null或长度为0是返回 <code>true</code>
     *
     * @param args
     * @return
     */
    public static boolean isEmpty(Object args) {
        return args == null || args.toString().trim().length() == 0;
    }
    ...
    public static boolean IsIntNumber(String value) {
        ...
        String regex = "^[0-9].*$";
        boolean flag=match(regex, value);
        if(flag){
            if(new BigDecimal(value).compareTo(new BigDecimal("0.01"))<0){
                return false;
            }
        }
        return flag;
    ...
    public static void main(String[] args) {
        System.err.print(IsIntNumber("0"));
    }
