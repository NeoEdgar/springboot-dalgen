...
import com.xl.dy.dal.mapper.HipUserDOMapper;
...
*/
@Repository
public class HipUserDAO{

    @Autowired
    private HipUserDOMapper hipUserDOMapper;
     ...
     * @return Long
     */
    public Long insert(HipUserDO entity){
        return hipUserDOMapper.insert(entity);
    }
    /**
     ...
     * @return Long
     */
    public Long update(HipUserDO entity){
        return hipUserDOMapper.update(entity);
    }
    /**
    ...
    public Long deleteByPrimary(Long userId){
        return hipUserDOMapper.deleteByPrimary(userId);
    }
    /**
     ...
     * @return HipUserDO
     */
    public HipUserDO getByPrimary(Long userId){
        return hipUserDOMapper.getByPrimary(userId);
    }
}
