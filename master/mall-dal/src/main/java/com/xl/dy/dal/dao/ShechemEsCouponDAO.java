...
import com.xl.dy.dal.mapper.ShechemEsCouponDOMapper;
...
*/
@Repository
public class ShechemEsCouponDAO{

    @Autowired
    private ShechemEsCouponDOMapper shechemEsCouponDOMapper;
     ...
     * @return Long
     */
    public Long insert(ShechemEsCouponDO entity){
        return shechemEsCouponDOMapper.insert(entity);
    }
    /**
     ...
     * @return Long
     */
    public Long update(ShechemEsCouponDO entity){
        return shechemEsCouponDOMapper.update(entity);
    }
    /**
    ...
    public Long deleteByPrimary(Integer id){
        return shechemEsCouponDOMapper.deleteByPrimary(id);
    }
    /**
     ...
     */
    public ShechemEsCouponDO getByPrimary(Integer id){
        return shechemEsCouponDOMapper.getByPrimary(id);
    }
    /**
     ...
     */
    public List<OldCouponShowVO> getCouponListByNum(Integer pageSize){
        return shechemEsCouponDOMapper.getCouponListByNum(pageSize);
    }
}
