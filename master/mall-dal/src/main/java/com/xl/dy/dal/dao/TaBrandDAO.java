...
import com.xl.dy.dal.mapper.TaBrandDOMapper;
...
*/
@Repository
public class TaBrandDAO{

    @Autowired
    private TaBrandDOMapper taBrandDOMapper;
     ...
     * @return Long
     */
    public Long insert(TaBrandDO entity){
        return taBrandDOMapper.insert(entity);
    }
    /**
     ...
     * @return Long
     */
    public Long update(TaBrandDO entity){
        return taBrandDOMapper.update(entity);
    }
    /**
    ...
    public Long deleteByPrimary(Long id){
        return taBrandDOMapper.deleteByPrimary(id);
    }
    /**
     ...
     * @return TaBrandDO
     */
    public TaBrandDO getByPrimary(Long id){
        return taBrandDOMapper.getByPrimary(id);
    }
    /**
     ...
     * @return TaBrandDO
     */
    public TaBrandDO getByPrimarySelective(Long id){
        return taBrandDOMapper.getByPrimarySelective(id);
    }
}
