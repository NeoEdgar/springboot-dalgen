...
import com.xl.dy.dal.mapper.TaOrderDetDOMapper;
...
*/
@Repository
public class TaOrderDetDAO{

    @Autowired
    private TaOrderDetDOMapper taOrderDetDOMapper;
     ...
     * @return Long
     */
    public Long insert(TaOrderDetDO entity){
        return taOrderDetDOMapper.insert(entity);
    }
    /**
     * desc:?��?�表:TA_ORDER_DET.<br/>
     ...
     * @return Long
     */
    public Long update(TaOrderDetDO entity){
        return taOrderDetDOMapper.update(entity);
    }
    /**
    ...
    public Long deleteByPrimary(Long id){
        return taOrderDetDOMapper.deleteByPrimary(id);
    }
    /**
     * desc:?��??主�???��???��??:TA_ORDER_DET.<br/>
     ...
     * @return TaOrderDetDO
     */
    public TaOrderDetDO getByPrimary(Long id){
        return taOrderDetDOMapper.getByPrimary(id);
    }
    /**
     * desc:?��??主�???��???��??:TA_ORDER_DET.<br/>
     ...
     * @return TaOrderDetDO
     */
    public TaOrderDetDO getOrderPrimary(){
        return taOrderDetDOMapper.getOrderPrimary();
    }
    /**
     ...
     */
    public List<TaOrderDetDO> getByOrderId(Long orderId){
        return taOrderDetDOMapper.getByOrderId(orderId);
    }
    /**
     * desc:根据主键获取数据:TA_ORDER_DET.<br/>
     ...
     * @return List<TaOrderDetDO>
     */
    public List<TaOrderDetDO> getInfoByOrderId(Long orderId){
        return taOrderDetDOMapper.getInfoByOrderId(orderId);
    }
    /**
     ...
     * @return Long
     */
    public Long updateByPrimarySelective(TaOrderDetDO entity){
        return taOrderDetDOMapper.updateByPrimarySelective(entity);
    }
    /**
     * desc:根据主键获取数据:TA_ORDER_DET.<br/>
     ...
     * @return List<TaOrderDetDO>
     */
    public List<TaOrderDetDO> getByOrderCode(String orderCode){
        return taOrderDetDOMapper.getByOrderCode(orderCode);
    }
    /**
     ...
     * @return QueryCompanyOrderListPage
     */
    public QueryCompanyOrderListPage getCompanyOrderList(QueryCompanyOrderListPage queryCompanyOrderList){
        int total = taOrderDetDOMapper.getCompanyOrderListCount(queryCompanyOrderList);
        if(total>0){
            queryCompanyOrderList.setDatas(taOrderDetDOMapper.getCompanyOrderListResult(queryCompanyOrderList));
        }
        queryCompanyOrderList.setTotal(total);
        return queryCompanyOrderList;
    }
    /**
     * desc:根据mallId获取不同类型的订单:TA_ORDER.<br/>
     ...
     * @return QueryMallOrderListPage
     */
    public QueryMallOrderListPage getMallOrderList(QueryMallOrderListPage queryMallOrderList){
        int total = taOrderDetDOMapper.getMallOrderListCount(queryMallOrderList);
        if(total>0){
            queryMallOrderList.setDatas(taOrderDetDOMapper.getMallOrderListResult(queryMallOrderList));
        }
        queryMallOrderList.setTotal(total);
        return queryMallOrderList;
    }
    /**
     * desc:根据主键获取数据:TA_ORDER_DET.<br/>
     ...
     * @return Integer
     */
    public Integer getOrderDetCountByOrderId(Long orderId){
        return taOrderDetDOMapper.getOrderDetCountByOrderId(orderId);
    }
    /**
     * desc:根据主键获取数据:TA_ORDER_DET.<br/>
     ...
     * @return GroupVO
     */
    public GroupVO getOrderDetByOrderId(Long id){
        return taOrderDetDOMapper.getOrderDetByOrderId(id);
    }
    /**
     ...
     * @return TaOrderDetDO
     */
    public TaOrderDetDO getOrderDetByCodeAndShopId(Long shopId,String consumeCode){
        return taOrderDetDOMapper.getOrderDetByCodeAndShopId(shopId, consumeCode);
    }
    /**
     ...
     * @return Integer
     */
    public Integer getConveredOrderDetByCode(String orderCode){
        return taOrderDetDOMapper.getConveredOrderDetByCode(orderCode);
    }
    /**
     * desc:根据主键获取数据:TA_ORDER_DET.<br/>
     ...
     * @return List<Map>
     */
    public List<Map> getShopIdAndGoodsIdByPayId(Long payId){
        return taOrderDetDOMapper.getShopIdAndGoodsIdByPayId(payId);
    }
    /**
     ...
     * @return Long
     */
    public Long deleteByOriOrderCode(String oriOrderCode){
        return taOrderDetDOMapper.deleteByOriOrderCode(oriOrderCode);
    }
}
