...
import com.xl.dy.dal.mapper.TaShopGoodsPropDOMapper;
...
*/
@Repository
public class TaShopGoodsPropDAO{

    @Autowired
    private TaShopGoodsPropDOMapper taShopGoodsPropDOMapper;
     ...
     * @return Long
     */
    public Long insert(TaShopGoodsPropDO entity){
        return taShopGoodsPropDOMapper.insert(entity);
    }
    /**
     ...
     * @return Long
     */
    public Long update(TaShopGoodsPropDO entity){
        return taShopGoodsPropDOMapper.update(entity);
    }
    /**
    ...
    public Long deleteByPrimary(Long id){
        return taShopGoodsPropDOMapper.deleteByPrimary(id);
    }
    /**
     ...
     */
    public TaShopGoodsPropDO getByPrimary(Long id){
        return taShopGoodsPropDOMapper.getByPrimary(id);
    }
    /**
     * desc:更新表:TA_SHOP_GOODS_PROP.<br/>
     ...
     * @return Long
     */
    public Long updateSelective(TaShopGoodsPropDO entity){
        return taShopGoodsPropDOMapper.updateSelective(entity);
    }
    /**
     ...
     * @return TaShopGoodsPropDO
     */
    public TaShopGoodsPropDO getByPrimarySelective(Long id,Long shopId,Long goodsId){
        return taShopGoodsPropDOMapper.getByPrimarySelective(id, shopId, goodsId);
    }
    /**
     * desc:根据主键获取有效数据:TA_SHOP_GOODS_PROP.<br/>
     ...
     * @return Integer
     */
    public Integer getCountByPrimarySelective(Long id,Long shopId,Long goodsId){
        return taShopGoodsPropDOMapper.getCountByPrimarySelective(id, shopId, goodsId);
    }
    /**
     * desc:根据主键获取数据:TA_SHOP_GOODS_PROP.<br/>
     ...
     * @return QueryShopGoodListPage
     */
    public QueryShopGoodListPage getShopGoodsPropByGoodsId(QueryShopGoodListPage queryShopGoodList){
        int total = taShopGoodsPropDOMapper.getShopGoodsPropByGoodsIdCount(queryShopGoodList);
        if(total>0){
            queryShopGoodList.setDatas(taShopGoodsPropDOMapper.getShopGoodsPropByGoodsIdResult(queryShopGoodList));
        }
        queryShopGoodList.setTotal(total);
        return queryShopGoodList;
    }
    /**
     * desc:根据主键删除数据:TA_SHOP_GOODS_PROP.<br/>
     ...
     * @return Long
     */
    public Long deleteShopGoodsProp(Long shopId,Long goodsId){
        return taShopGoodsPropDOMapper.deleteShopGoodsProp(shopId, goodsId);
    }
    /**
     * desc:根据主键删除数据:TA_SHOP_GOODS_PROP.<br/>
     ...
     * @return Long
     */
    public Long deleteShopGoodsPropByShopIdAndGoodsId(Long shopId,Long goodsId){
        return taShopGoodsPropDOMapper.deleteShopGoodsPropByShopIdAndGoodsId(shopId, goodsId);
    }
    /**
     * desc:根据主键获取数据:TA_SHOP_GOODS_PROP.<br/>
     ...
     * @return Long
     */
    public Long getSalesByGoodsIdAndShopId(Long shopId,Long goodsId){
        return taShopGoodsPropDOMapper.getSalesByGoodsIdAndShopId(shopId, goodsId);
    }
    /**
     ...
     * @return Long
     */
    public Long deleteShopGoodsBySkuIdAndShopId(Long skuId,Long shopId){
        return taShopGoodsPropDOMapper.deleteShopGoodsBySkuIdAndShopId(skuId, shopId);
    }
    /**
     ...
     * @return QueryGoodsListPage
     */
    public QueryGoodsListPage getGoodsPage(QueryGoodsListPage queryGoodsList){
        int total = taShopGoodsPropDOMapper.getGoodsPageCount(queryGoodsList);
        if(total>0){
            queryGoodsList.setDatas(taShopGoodsPropDOMapper.getGoodsPageResult(queryGoodsList));
        }
        queryGoodsList.setTotal(total);
