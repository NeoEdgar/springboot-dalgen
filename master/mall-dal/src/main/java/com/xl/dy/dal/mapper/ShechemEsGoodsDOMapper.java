 ...
 * SHECHEM_ES_GOODS
 */
public interface ShechemEsGoodsDOMapper{
     ...
     * @return Long
     */
    Long insert(ShechemEsGoodsDO entity);
    /**
     ...
     * @return Long
     */
    Long update(ShechemEsGoodsDO entity);
    /**
     ...
     */
    ShechemEsGoodsDO getByPrimary(Integer id);
    /**
     * desc:商品分页.<br/>
     ...
     * @return int
     */
    int getOldGoodsPageCount(QueryOldGoodsListPage queryOldGoodsList);
    /**
     * desc:商品分页.<br/>
     * descSql =  SELECT id ,store_id ,title ,thumb ,content ,is_real FROM SHECHEM_ES_GOODS WHERE mid = 'DJEHBSUAAY' ORDER BY id DESC
     * @param queryOldGoodsList queryOldGoodsList
     * @return List<Map>
     */
    List<Map> getOldGoodsPageResult(QueryOldGoodsListPage queryOldGoodsList);
    /**
     * desc:商品分页.<br/>
     ...
     */
    List<OldGoodShowVO> getGoodsListByNum(Integer pageSize);
}
