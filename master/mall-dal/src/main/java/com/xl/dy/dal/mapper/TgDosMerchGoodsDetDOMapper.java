 ...
 */
public interface TgDosMerchGoodsDetDOMapper{
     ...
     * @return Long
     */
    Long insert(TgDosMerchGoodsDetDO entity);
    /**
     ...
     * @return Long
     */
    Long update(TgDosMerchGoodsDetDO entity);
    /**
     ...
     */
    TgDosMerchGoodsDetDO getByPrimary(Long id);
    /**
     ...
     * @return Integer
     */
    Integer getMonthlyEffectiveGoodsQuantity(Integer index);
    /**
     ...
     * @return Integer
     */
    Integer getCompanyShopGoodsCount(@Param("companyId")Long companyId,@Param("shopStatus")String shopStatus,@Param("shopGoodsSaleStatus")String shopGoodsSaleStatus);
    /**
     ...
     * @return List<Map>
     */
    List<Map> getCompanyShopGoodsCountByCategoryList(@Param("companyId")Long companyId,@Param("shopStatus")String shopStatus,@Param("shopGoodsSaleStatus")String shopGoodsSaleStatus);
    /**
     ...
     * @return Integer
     */
    Integer getMallShopGoodsCount(Long mallId);
    /**
     ...
     * @return Integer
     */
    Integer getNewOnSaleShopGoods(@Param("mallId")Long mallId,@Param("endIndex")Integer endIndex,@Param("beginIndex")Integer beginIndex);
    /**
     ...
     * @return Integer
     */
    Integer getSaleGoodsCount(@Param("mallId")Long mallId,@Param("shopId")Long shopId,@Param("companyId")Long companyId,@Param("endIndex")Integer endIndex,@Param("beginIndex")Integer beginIndex);
    /**
     ...
     * @return List<Map>
     */
    List<Map> getOrderDataByCategoryList(Long companyId);
    /**
     ...
     * @return List<Map>
     */
    List<Map> getCompanyShopCountByCategoryList(Long companyId);
}
